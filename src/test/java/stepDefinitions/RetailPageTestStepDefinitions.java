...
public class RetailPageTestStepDefinitions extends Base {
	...
	@When("^User fill Registration form with Below information$")
	public void user_fill_Registration_form_with_Below_information(DataTable personalInfo) throws Throwable {
	    ...
	    retailPage.confirmPassword(dataValues.get(0).get("confirmPassword"));
